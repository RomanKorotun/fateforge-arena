...
export class AddAddressDto {
  @ApiProperty({ description: 'Імʼя користувача', example: 'Bill' })
  @IsNotEmpty({ message: 'Поле firstName не може бути пустим' })
  @IsString({ message: 'Поле firstName повинно бути рядком' })
  firstName!: string;

  @ApiProperty({ description: 'Прізвище користувача', example: 'Gates' })
  ...
  @ApiProperty({ description: 'Поштовий індекс', example: '02000' })
  ...
  @ApiProperty({ description: 'Адреса', example: 'вул. Шевченка, 12' })
